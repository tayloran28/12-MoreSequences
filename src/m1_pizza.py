...
def run_test_generate_points_on_circle():
    ...
    # Test 1:
    expected = [rg.Point(74.0, -200),  # All numbers are approximate.
                rg.Point(72.0, -196.5),
                rg.Point(68.0, -196.5),
                rg.Point(66.0, -200.0),
                rg.Point(68.0, -203.5),
                rg.Point(72.0, -203.5)]
    circle = rg.Circle(rg.Point(70, -200), 4)
    answer = generate_points_on_circle(circle, 6)
...
def run_test_pizza():
    ...
    title = 'Pizza Test 4: 200 SLices, thin black lines on yellow'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_polygon():
    ...
    title = 'Test 4: 4 segments with black lines'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_fancy_polygon():
    ...
    # Test 4:
    title = ('Test 4:  20 blue lines on lime green circle,'
             + ' hops = 5.')
    window = rg.RoseWindow(400, 400, title)
    ...
    circle.fill_color = 'purple'
    fancy_polygon(window, circle, 100, 25, 'black', 1)
    window.close_on_mouse_click()
    ...
    circle.fill_color = 'yellow'
    fancy_polygon(window, circle, 500, 125, 'black', 1)
    window.close_on_mouse_click()
